...
const init = () => {
  if (docStore.globalParams) {
    ...
    for (const name in docStore.globalParams.header) {
      globalParams.header.push({ name, value: docStore.globalParams.header[name] });
    }
    for (const name in docStore.globalParams.query) {
      globalParams.query.push({ name, value: docStore.globalParams.query[name] });
    }
    for (const name in docStore.globalParams.body) {
      globalParams.body.push({ name, value: docStore.globalParams.body[name] });
    }
  }
};
